...
public class AmazonSES {
	...
	final String FROM = "vitorcorreadev@gmail.com";

	// The subject line for the email.
	final String SUBJECT = "One last step to complete your registration with Our App";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://ec2-34-242-66-80.eu-west-1.compute.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://ec2-34-242-66-80.eu-west-1.compute.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	public void verifyEmail(UserDto userDto) {
		...
		System.setProperty("aws.accessKeyId", "AKIAIMO3ZOAMP3JG36TQ");
		System.setProperty("aws.secretKey", "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");
